...
class Pathset(object):
    ...
    def covered_nodes(self, result):
        ...
        Returns return_covered_nodes, which is a list of nodes that are covered by these delay-defining paths.
        """
        ...
        return_covered_nodes = list(set(covered_nodes))
        return_covered_nodes = sorted(list(set(return_covered_nodes)), key=lambda number: int(number[1:]))

        return return_covered_nodes
